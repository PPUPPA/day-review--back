    ...
    <main id="main" class="main">
      <div class="auth">
        ...
        <article class="auth__content">
          ...
          <form class="auth__form" name="login" action="login_action.do" method="post">
            <div class="auth__login">
              <div class="auth__login-item">
                ...
                <a href="idInquiry_view.do" class="auth__find">가입 이메일 찾기</a>
              </div>
              <div class="auth__login-item">
                ...
                <a href="pwInquiry_view.do" class="auth__find">임시 비밀번호 발급</a>
              </div>
            </div>

            <div class="auth__btn-wrap">
              <button type="submit" class="c-button auth__btn-login default large" disabled>로그인하기</button>
              <div class="auth__init">
                <span class="auth__init-text">처음이신가요?</span>
                <a href="join_view.do" class="auth__init-link">회원가입</a>
              </div>
            </div>
          </form>
        </article>
